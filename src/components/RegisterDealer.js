...
class RegisterDealer extends Component { 
    ...
    componentDidMount(){ 
        ...
        if(this.state.id === '_add'){ 
            ...
            DealerService.getDealers(dealerId).then( (res) =>{ 
    ...
    //         return <h3 className="text-center">Add Dealer</h3> 
...
{/* 
                                        <div className = "form-group"> 
                                            ...
                                            <input type = "number" placeholder=" Enter Dealer Id" 
                                        ...
                                        <div className = "form-group"> 
                                            ...
                                            <input type="text" placeholder="Enter Name"  pattern="[A-Za-z]{1,15}"
                                                
                                                name="name" className="form-control" title="Name should only contain alphabets." 

                                                value={this.state.dealerName} onChange={this.changeNameHandler}required/> 
                                        ...
                                        <div className = "form-group"> 
                                            ...
                                            <input type= "email" placeholder=" Enter Email Address" name="emailId" className="form-control" 
                                        ...
                                        <button className="btn btn-success" onClick={this.addDealer}>Register</button> 
